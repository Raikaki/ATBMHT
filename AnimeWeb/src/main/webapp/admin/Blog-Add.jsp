...
<div class="wrapper">
    ...
    <div id="content-page" class="content-page">
        <div class="container-fluid">
            <form method="post" action="${AddBlog}?action=addblog" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">Thêm Blog mới</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                                ...
                                <div class="form-group">
                                    <div class="add-img-user profile-img-edit">
                                        ...
                                        <div class="p-image">
                                            <label
                                                    class="upload-button btn iq-bg-primary">Tệp văn bản (.doc,.docx) <input
                    ...
                    <div class="col-lg-9">
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">Thông tin blog mới</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
