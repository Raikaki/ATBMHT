...
@WebServlet(name = "AddBonusMovie", value = "/admin/AddBonusMovie")
public class AddBonusMovie extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String idBonus = request.getParameter("idBonus");
        String idMovieBonus = request.getParameter("idMovieBonus");
        boolean isSuccess = DAOBonus.addBonusMovie(idBonus,idMovieBonus);
        Gson gson = new Gson();
