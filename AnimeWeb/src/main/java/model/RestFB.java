...
public class RestFB {
    ...
    public static User getUserInfo(String accessToken) {
        ...
        FacebookClient.AccessToken extendedAccessToken = facebookClient.obtainExtendedAccessToken(Constants.FACEBOOK_APP_ID, Constants.FACEBOOK_APP_SECRET, accessToken);
        facebookClient = new DefaultFacebookClient(extendedAccessToken.getAccessToken(), Constants.FACEBOOK_APP_SECRET, Version.LATEST);
