                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    <div class="section-title">
                                        ...
                                        <form class="sort" action="${Index}" method="post">
                                            ...
                                            <option value="isDescPrice">
                                                <fmt:message>sort.decrease</fmt:message></option>
                                            <option value="notDescPrice">
                                                <fmt:message>sort.ascending</fmt:message></option>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-end mb-0">
                            <li class="page-item "><a class="page-link"
                                                              href="${Index}?&&index=${requestScope.index-1}&&filter=${requestScope.param}"
                                                              tabindex="-1"
                            ...
                            <li class="page-item"><a class="page-link"
                                                     href="${Index}?&&index=${requestScope.index+1}&&filter=${requestScope.param}">Next</a>
                            </li>
                        </ul>
                    </nav>
