...
<html>
<head>
    <title>Import Coupon History</title>
                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="table-responsive">
                                <table id="importCoupons" class="table table-striped table-bordered">
                                    <thead>
                                    <tr>
                                        <th>Nhà cung cấp</th>
                                        <th>Tên phim</th>
                                    ...
                                    <tbody>
                                    <c:forEach var="row" items="${requestScope.importCoupons}">
                                        <tr>
                                                    ...
                                                    <td>
                                                        <button  class="iq-bg-primary" data-toggle="tooltip"
                                                                 ...
                                                                 data-original-title="Delete" type="button" onclick= "RemoveImports(${row.id},this)">
...
<script>
    function RemoveImports(id,button) {
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#importCoupons').DataTable().row($($(button).closest('tr'))).remove().draw(false);
                    },
                    error: function (data) {
